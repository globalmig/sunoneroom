...
export const metadata: Metadata = {
  ...
  description: "금촌역 2번출구 도보 5분, 파주 고시원·원룸텔. 풀옵션 독립 각방, 24시간 CCTV 보안, 전용 주차장, 옥상 테라스. 보증금 0원, 월 36만원부터.",
  ...
  openGraph: {
    ...
    description: "금촌역 2번출구 도보 5분, 파주 고시원·원룸텔. 풀옵션 독립 각방, 24시간 CCTV 보안, 전용 주차장.",
    images: [{ url: "/images/room/main.png", width: 1200, height: 630, alt: "썬원룸텔 금촌역점" }],
  },
  twitter: {
    card: "summary_large_image",
    title: "썬원룸텔 | 금촌역 고시원·원룸텔",
    description: "금촌역 2번출구 도보 5분, 파주 고시원·원룸텔. 풀옵션 독립 각방, 24시간 CCTV 보안.",
