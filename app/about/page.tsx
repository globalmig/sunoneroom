    ...
    <div className="bg-[#f6f8f9] text-[#20282d]">
      <section className="px-4 pt-[118px]">
        <div className="mx-auto max-w-[1200px]">
          <p className="anim-fade-up text-xs tracking-[0.22em] text-[#6f7780]">
            ABOUT STAY ONE
          </p>
          <div className="mt-4 grid gap-8 lg:grid-cols-[1.2fr_0.8fr] lg:items-end">
            ...
            <p
              className="anim-fade-up text-base leading-8 text-[#4f5661] lg:text-right"
              style={{ animationDelay: "120ms" }}
            >
              공간에 프리미엄을 더하고, 생활에 품격을 더하는
              <br />
              단기 거주형 프리미엄 레지던스를 제안합니다.
            </p>
          </div>

          <div
            className="anim-fade-up mt-10 grid gap-6 border-y border-black/15 py-6 lg:grid-cols-3"
      ...
      <section className="px-4 py-14">
        <div className="mx-auto grid max-w-[1200px] gap-4 lg:grid-cols-[1fr_1fr_0.9fr]">
          <div className="anim-fade-up relative min-h-[380px] overflow-hidden rounded-3xl lg:min-h-[520px]">
            <Image
              src="https://cdn.qshop.ai/22039/gallery/b2628890e46011ef9da2952c4dee4c89.jpeg"
              alt="스테이원 공간 이미지"
              fill
          ...
          <div
            className="anim-fade-up relative min-h-[300px] overflow-hidden rounded-3xl lg:min-h-[520px]"
            style={{ animationDelay: "120ms" }}
          >
            <Image
              src="https://cdn.qshop.ai/22039/gallery/8aa744a0fb2e11ef9964fd11d987c868.jpeg"
              alt="스테이원 객실 이미지"
              fill
              className="object-cover"
            />
          ...
          <div
            className="anim-fade-up flex min-h-[220px] items-end rounded-3xl bg-[#111823] p-6 text-white lg:min-h-[520px]"
      ...
      <section
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(17,24,35,.34), rgba(17,24,35,.34)), url('https://cdn.qshop.ai/22039/gallery/b2628890e46011ef9da2952c4dee4c89.jpeg')",
        }}
      />
        ...
        <div className="mx-auto max-w-[1200px]">
          <div className="anim-fade-up mb-12 flex flex-col items-start justify-between gap-4 border-b border-black/10 pb-6 md:flex-row md:items-end">
            ...
            <p className="text-sm text-[#646b76]">
              카드형은 서비스 리스트에만 적용하고, 나머지는 레이아웃 중심으로 구성했습니다.
            </p>
          </div>
